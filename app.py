    ...
    messages_payload = [
        {
            ...
            Provide a balanced response. Explain concepts clearly. 
...
# Text Submission Handling (No text-to-speech sound is auto-triggered)
...
# Microphone Voice Submission Handling (Triggers auto voice playback response)
